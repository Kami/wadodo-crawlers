# Scrapy settings for coachspree_crawlers project
#
...
BOT_NAME = 'coachspree_crawlers'

SPIDER_MODULES = ['coachspree_crawlers.spiders']
NEWSPIDER_MODULE = 'coachspree_crawlers.spiders'
